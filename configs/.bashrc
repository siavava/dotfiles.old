...
if [ "$color_prompt" = yes ]; then
    ...
    prompt_symbol="⚡"
    noxiur="λ"
    PS1=$prompt_color'┌──[\[\033[0;1m\]$prompt_symbol\w'$prompt_color']\n'$prompt_color'└─'$info_color'\$\[\033[0m\] '
    # my prompt
	PS1=$'\e[0;31mλ> \e[0m'
    
    #### OLD
    # PS1=$prompt_color'┌──${debian_chroot:+($debian_chroot)──}${VIRTUAL_ENV:+(\[\033[0;1m\]$(noxiur)'$prompt_color')}('$info_color'$noxiur'$prompt_color')-[\[\033[0;1m\]$prompt_symbol\w'$prompt_color']\n'$prompt_color'└─'$info_color'\$\[\033[0m\] '

    # PS1=$prompt_color'┌──${debian_chroot:+($debian_chroot)──}${VIRTUAL_ENV:+(\[\033[0;1m\]$(noxiur)'$prompt_color')}('$info_color'$noxiur'$prompt_color')-[\[\033[0;1m\]\w'$prompt_color']\n'$prompt_color'└─'$info_color'\$\[\033[0m\] '
